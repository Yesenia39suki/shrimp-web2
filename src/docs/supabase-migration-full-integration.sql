...
revoke all on function public.refresh_pond_daily_snapshot(uuid, uuid, date) from public;
...
grant execute on function public.refresh_pond_daily_snapshot(uuid, uuid, date) to authenticated;
